...
{"id":"1b6167b8-c774-485f-87fb-d7f1430f83d8","description":"Get Completed Todos","cardinality":"one-to-many","dataFields":[{"name":"Todo Title","type":null},{"name":"Completion Date","type":null},{"name":"Completion Notes","type":null},{"name":"Original Due Date","type":null},{"name":"Current Status","type":null}],"gwtDescriptions":["Given a completed todo, When the user marks it as reopened, Then the todo's status is changed back to active."]}
